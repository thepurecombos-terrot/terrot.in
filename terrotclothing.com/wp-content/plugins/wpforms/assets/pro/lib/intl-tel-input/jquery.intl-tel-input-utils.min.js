(function() {
    ...
    */
    ...
    function t(a, b) {
        for (var c = ma(a.j()), d = 0; d < c.length; d++) {
            ...
            if (null != b.g[e]) {
                ...
                } else f = v(b, e), g ? (g = v(a, e)) ? t(g, f) : q(a, e, f.clone()) : q(a, e, f)
            }
        }
    }
    ...
    z.prototype.i = function(a, b) {
        ...
        if (14 == a.i) return "string" === typeof b && na.test(b) && (a = Number(b), 0 < a) ? a : b;
        if (!a.u) return b;
        a = a.v;
        if (a === String) {
            if ("number" === typeof b) return String(b)
        } else if (a === Number && "string" === typeof b && ("Infinity" === b || "-Infinity" === b || "NaN" === b || na.test(b))) return Number(b);
        return b
    };
    var na = /^-?[0-9]+$/;
    ...
    var J = {
        ...
        ta = {
            ...
            MN: [, [, , "[12]\\d{7,9}|[5-9]\\d{7}", , , , , , , [8, 9, 10],
                ...
                [, , , , , , , , , [-1]],
                [, , , , , , , , , [-1]],
                [, , "712[0-79]\\d{4}|7(?:1[013-9]|[25-9]\\d)\\d{5}", , , , "75123456", , , [8]], "MN", 976,
                "001", "0", , , "0", , , , [
    ...
    */
    ...
    function O(a, b) {
        for (var c = new D, d, f = a.length, e = 0; e < f; ++e) d = a.charAt(e), d = b[d.toUpperCase()], null != d && c.g(d);
        return c.toString()
    }
    ...
    function La(a, b, c) {
        ...
        null != a && (g = a, a = w(g, 2), e = new RegExp(p(g, 1)), w(g, 5),
            g = w(g, 4), f = 2 == c && null != g && 0 < g.length ? f.replace(e, a.replace(Ga, g)) : f.replace(e, a), 3 == c && (f = f.replace(RegExp("^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e]+"), ""), f = f.replace(RegExp("[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e]+", "g"), "-")));
        return Ma(d, c, f, b)
    }
    ...
    function Y(a, b, c, d) {
        ...
        f = u(f, 10);
        if (2 == d)
            if (Ka(U(c, 0))) a = U(c, 1), Ka(a) && (e = e.concat(0 == x(a, 9) ? u(p(c, 1), 9) : u(a, 9)), e.sort(), 0 == f.length ? f = u(a, 10) : (f = f.concat(u(a, 10)), f.sort()));
    ...
    function Pa(a, b, c, d, f, e) {
        ...
        var h = b.toString();
        if (0 == h.length) g = 20;
        else if (L.test(h)) h = h.replace(L, ""), b.i = "", b.g(Ia(h)), g = 1;
        else {
            h = new RegExp(g);
            Ja(b);
            g = b.toString();
            if (0 == g.search(h)) {
                ...
                l && null != l[1] && 0 < l[1].length && "0" == O(l[1], ua) ? g = !1 : (b.i = "", b.g(g.substring(h)), g = !0)
            } else g = !1;
            g = g ? 5 : 20
        }
        f && q(e, 6, g);
        ...
        if (null != c && (g = w(c, 10), h = "" + g, l = b.toString(), 0 == l.lastIndexOf(h, 0) && (h = new D(l.substring(h.length)), l = p(c, 1), l = new RegExp(w(l, 2)), Qa(h, c, null), h = h.toString(), !N(l, b.toString()) && N(l, h) || 3 == Y(a, b.toString(), c, -1)))) return d.g(h), f && q(e, 6, 10), q(e, 1, g), g;
        q(e, 1, 0);
        return 0
    }
        ...
        if (0 != f && null != e && 0 != e.length) {
            ...
            if (f = g.exec(d)) {
                ...
                if (null == b || 0 == b.length || null == f[l] || 0 == f[l].length) {
                    if (!h || N(e, d.substring(f[0].length))) null != c && 0 < l && null != f[l] && c.g(f[1]), a.set(d.substring(f[0].length))
    ...
    function Ra(a, b, c, d) {
        ...
        var h = e;
        null == h ? g = !0 : 0 === h.length ? g = !1 : (g = Ba.exec(h), h = Ca.exec(h), g = null !== g || null !== h);
        if (!g) throw Error("The string supplied did not seem to be a phone number");
        null != e ? ("+" === e.charAt(0) && f.g(e), e = b.indexOf("tel:"), f.g(b.substring(0 <= e ? e + 4 : 0, b.indexOf(";phone-context=")))) : (e = f.g, g = b ? ? "", h = g.search(xa), 0 <= h ? (g = g.substring(h), g = g.replace(za, ""), h = g.search(ya), 0 <= h && (g = g.substring(0, h))) : g = "", e.call(f, g));
        e = f.toString();
        g = e.indexOf(";isub=");
        0 < g && (f.i = "", f.g(e.substring(0, g)));
        if (!Ha(f.toString())) throw Error("The string supplied did not seem to be a phone number");
        e = f.toString();
        if (!(P(c) || null != e && 0 < e.length && L.test(e))) throw Error("Invalid country calling code");
        e = new I;
        d && q(e, 5, b);
        a: {
            b = f.toString();g = b.search(Ea);
        ...
        try {
            ...
            if ("Invalid country calling code" == F.message && L.test(l)) {
                if (l = l.replace(L, ""), h = Pa(a, l, g, b, d, e), 0 == h) throw F;
            } else throw F;
        }
        0 != h ? (f = S(h), f != c && (g = R(a, h, f))) : (Ja(f), b.g(f.toString()), null != c ? (h = w(g, 10), q(e,
            1, h)) : d && (delete e.g[6], e.i && delete e.i[6]));
        if (2 > b.i.length) throw Error("The string supplied is too short to be a phone number");
        null != g && (c = new D, f = new D(b.toString()), Qa(f, g, c), a = Y(a, f.toString(), g, -1), 2 != a && 4 != a && 5 != a && (b = f, d && 0 < c.toString().length && q(e, 7, c.toString())));
        d = b.toString();
        a = d.length;
